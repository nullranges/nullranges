...
The following code is used to obtain `seqlengths` for the DHS peaks,
as these are needed for block bootstrapping.
...
microbenchmark(
  list=alist(
    p_within=bootRanges(pks, blockLength=blockLength,
                        type="permute", withinChrom=TRUE),
    b_within=bootRanges(pks, blockLength=blockLength,
                        type="bootstrap", withinChrom=TRUE),
    p_across=bootRanges(pks, blockLength=blockLength,
                        type="permute", withinChrom=FALSE),
    b_across=bootRanges(pks, blockLength=blockLength,
