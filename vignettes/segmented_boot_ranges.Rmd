...
Some processing to align these features with our excluded regions and our
...
Here we import excluded regions (as created by Kundaje et al). 

TODO: here instead use Mikhail's *excluderanges* package, once it is available.
...
plots <- lapply(c("ranges","barplot","boxplot"), function(t) plotSegment(seg_hmm, exclude, type = t))
plots[[1]]
plots[[2]] + plots[[3]]
```
...
not contain small ranges. If you wanted to also avoid generation of
