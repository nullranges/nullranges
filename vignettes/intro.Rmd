...
sets for exploring the null hypothesis of overlap or colocalization of
two observed feature sets.
...
2. Generating new a set of genomic features $y'$, constructing them
...
implemented options for bootstrapping across or within chromosome, and
