...
```{r cont-cov, fig.width=11, fig.height=4}
...
```{r disc-bin-cov, fig.width=11, fig.height=4}
## Define focal, pool and covar
...
```{r disc-cov, fig.width=11, fig.height=4}
...
```{r focal-gt-pool, fig.width=8, fig.height=4}
## Define focal, pool and covar
focal <- epp[epp$epDistance >= 40e03]
pool  <- epp[epp$epDistance <  40e03]
